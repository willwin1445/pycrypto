...
def my_portfolio():
    url = 'https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=300&convert=USD&CMC_PRO_API_KEY=ff8e2558-a0ce-42f5-9bab-9c145bc53e3a'
    ...
    for i in range(0,300):
        for coin in coins:
            if api["data"][i]["symbol"] == coin[1]:
                ...
                name = Label(pycrypto, text=api["data"][i]["symbol"], bg="#F3F4F6", fg="black", font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
                ...
                no_coins = Label(pycrypto, text=coin[2], bg="#F3F4F6", fg="black", font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
                ...
                current_val = Label(pycrypto, text="${0:.2f}".format(current_value), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(current_value))), font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
                ...
                totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl_percoin), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(total_pl_percoin))), font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    add_coin = Button(pycrypto, text="Add Coin", bg="#142E54", fg="black",command=insert_coin, font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    update_coin_txt = Button(pycrypto, text="Update Coin", bg="#142E54", fg="black",command=update_coin, font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    delete_coin_txt = Button(pycrypto, text="Delete Coin", bg="#142E54", fg="black",command=delete_coin, font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    delete_coin_txt.grid(row=coin_row+3, column=4, sticky=N+S+E+W)

    ####
    totalpaid = Label(pycrypto, text="${0:.2f}".format(total_amount_paid), bg="#F3F4F6", fg="black", font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    totalpaid.grid(row=coin_row, column=4, sticky=N+S+E+W)

    totalcv = Label(pycrypto, text="${0:.2f}".format(total_current_value), bg="#F3F4F6", fg="black", font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    totalcv.grid(row=coin_row, column=5, sticky=N+S+E+W)

    totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(total_pl))), font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
    totalpl.grid(row=coin_row, column=7, sticky=N+S+E+W)

    api = ""

    refresh = Button(pycrypto, text="Refresh", bg="#142E54", fg="black",command=reset, font="Lato 12",padx="5", pady="5", borderwidth=2, relief="groove")
